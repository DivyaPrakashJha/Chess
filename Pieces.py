...
kingW = King('W', (4, 7), (9, 4))
queenW = Queen('W', (3, 7), (9, 3))
bishopWb = Bishop('W', (2, 7), (9, 2))
bishopWw = Bishop('W', (5, 7), (9, 5))
knightW1 = Knight('W', (1, 7), (9, 1))
knightW2 = Knight('W', (6, 7), (9, 6))
rookW1 = Rook('W', (0, 7), (9, 0))
rookW2 = Rook('W', (7, 7), (9, 7))
pawnW1 = Pawn('W', (0, 6), (8, 0))
pawnW2 = Pawn('W', (1, 6), (8, 1))
pawnW3 = Pawn('W', (2, 6), (8, 2))
pawnW4 = Pawn('W', (3, 6), (8, 3))
pawnW5 = Pawn('W', (4, 6), (8, 4))
pawnW6 = Pawn('W', (5, 6), (8, 5))
pawnW7 = Pawn('W', (6, 6), (8, 6))
pawnW8 = Pawn('W', (7, 6), (8, 7))
...
kingB = King('B', (4, 0), (-2, 4))
queenB = Queen('B', (3, 0), (-2, 3))
bishopBw = Bishop('B', (2, 0), (-2, 2))
bishopBb = Bishop('B', (5, 0), (-2, 5))
knightB1 = Knight('B', (1, 0), (-2, 1))
knightB2 = Knight('B', (6, 0), (-2, 6))
rookB1 = Rook('B', (0, 0), (-2, 0))
rookB2 = Rook('B', (7, 0), (-2, 7))
pawnB1 = Pawn('B', (0, 1), (-1, 0))
pawnB2 = Pawn('B', (1, 1), (-1, 1))
pawnB3 = Pawn('B', (2, 1), (-1, 2))
pawnB4 = Pawn('B', (3, 1), (-1, 3))
pawnB5 = Pawn('B', (4, 1), (-1, 4))
pawnB6 = Pawn('B', (5, 1), (-1, 5))
pawnB7 = Pawn('B', (6, 1), (-1, 6))
pawnB8 = Pawn('B', (7, 1), (-1, 7))
